                                ...
                                <li class="bg-gray-100 rounded-lg p-3 shadow">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <form action="{{ route('orders.updateQuantity', ['orderId' => $order->id, 'productId' => $product->id]) }}" method="POST" class="flex items-center space-x-2 quantity-form">
                                            ...
                                            <button type="button" class="decrease-quantity h-10 w-10 bg-gray-200 rounded-full flex items-center justify-center text-xl font-bold">
                                            ...
                                            <button type="button"  class="increase-quantity h-10 w-10 bg-gray-200 rounded-full flex items-center justify-center text-xl font-bold">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <form action="{{ route('orders.removeProduct', ['orderId' => $order->id, 'productId' => $product->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="increase-quantity h-10 w-10 bg-red-500 rounded-full flex items-center justify-center">
