                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="category-option border-2 border-yellow-300 rounded-lg p-4 cursor-pointer">
                                <input type="radio" name="category" id="food" value="food" class="hidden"
                                    {{ old('category', $product->category) == 'food' ? 'checked' : '' }}>
                            ...
                            <div class="category-option border-2 border-red-300 rounded-lg p-4 cursor-pointer">
                                <input type="radio" name="category" id="drink" value="drink" class="hidden"
                                    {{ old('category', $product->category) == 'drink' ? 'checked' : '' }}>
                            ...
                            <div class="category-option border-2 border-purple-300 rounded-lg p-4 cursor-pointer">
                                <input type="radio" name="category" id="other" value="other" class="hidden"
                                    {{ old('category', $product->category) == 'other' ? 'checked' : '' }}>
